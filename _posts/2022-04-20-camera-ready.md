---
title: "Instructions about Camera-Ready Submission"
...
## 2.1 Metadata (Title, Authors and Abstract in the Camera-Ready Form)
...
## 2.2 Main Paper (PDF in the Form)
...
The maximum size of the PDF file (including the Appendices, see Section 3) should be no more than **20MB**.
...
The ACL 2022  and NAACL 2022 publication chairs have developed a package called [aclpub_check](https://github.com/acl-org/aclpubcheck) to automate much of the format checking 
(See the Appendix for a link to a tutorial on how to use it). Please run this package before submitting your paper to OpenReview in order not to miss some subtle formatting details. 
Note: We also strongly advise authors to use [rebiber](https://github.com/yuchenlin/rebiber) to update their bib files with updated citations automatically.
...
* The Appendix (if exists) should appear after the references, as part of the same PDF file (see Section 3); in contrast, the supplemental materials should appear as separate ZIP files (see Section 5).
...
You need to run the [aclpub_check](https://github.com/acl-org/aclpubcheck) package (see the Appendix for a tutorial on how to use it), and pay special attention to the following:
...
## 2.3 The Appendices (As the Last Part of the PDF File)
...
## 2.4. Copyright Consent (In the Form)
...
## 2.5. Supplementary Material (Dataset and Code in the Form)
...
## 2.6. Additional Rubric for Conditionally Accepted Papers (Respond to the Ethics Reviews in the Form)
...
## 2.8. Questions or Comments
If you have any questions about 

* the camera-ready version, please contact our publication chair [ryan.cotterell@gmail.com](mailto:ryan.cotterell@gmail.com);
* the Ethics reviews, please contact the Ethics Committee chairs [naacl22ethics@googlegroups.com](mailto:naacl22ethics@googlegroups.com).

For any other questions, please contact the NAACL 2022 Program Chairs.

## 2.9 Access the package to check the paper format
